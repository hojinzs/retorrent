...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, motion = "default", mobileFullscreen = false, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        mobileFullscreen
          ? "inset-x-0 bottom-0 top-auto max-h-screen max-w-none translate-x-0 translate-y-0 rounded-t-2xl sm:left-1/2 sm:top-1/2 sm:max-h-[calc(100vh-4rem)] sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg"
          : "left-1/2 top-1/2 max-w-lg translate-x-[-50%] translate-y-[-50%] sm:rounded-lg",
        className
      )}
      {...props}
    >
