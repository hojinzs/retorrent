                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={setUseIncompleteDir}
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={setStartWhenAdded}
                    />
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Input
                      ...
                      className="w-20 bg-input-background border-border"
                      type="number"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <Checkbox
                      ...
                      onCheckedChange={setStopRatioEnabled}
                    />
                  ...
                  <div className="flex items-center gap-4">
                    <Checkbox
                      ...
                      onCheckedChange={setStopIdleEnabled}
                    />
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <Checkbox
                      ...
                      onCheckedChange={setUploadLimitEnabled}
                    />
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={setLimitBandwidthPriority}
                    />
